package application;
	...
	public class TimeInputErrorHandling {
		 ...
		 * @return duration
		 * @returns false if null or empty string and returns true otherwise
		 */
		...
		/**
		 * This method checks to see if theres more than 1 decimal points and if the time 
		 * input by the user is over 24 hours, throws an exception 
		 * @return
